...
## Bagaimana Caranya?
Sebelum mengikuti, diharapkan teman-teman yang ingin berpartisipasi sudah paham tentang perintah dasar Git, seperti `clone`, `commit` dan `push`, karena ini dibutuhkan dalam tahapan pembuatan _pull request_.
#### Langkah-langkah
...
6. Lakukan _push_ hasil _commit_ diatas dengan menggunakan perintah berikut:
   ...
   ```
7. Teman-teman bisa menyelesaikan pembuatan _pull request_ dengan kembali mengunjungi halaman repositori di akun masing-masing, lalu menekan tombol "Create Pull Request" yang berwarna hijau dan mengikuti panduan _pull request_ hingga selesai.
